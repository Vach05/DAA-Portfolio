...
void case1(const vector<Location>& cities)
 {
    ...
    // Assume the first city is the warehouse
    Location warehouse = cities[0]; 
...
void searchClosestDriver(const vector<Driver>& drivers, const vector<Location>& cities)
 {
    ...
    // Get selected city's location
    Location cityLocation = cities[cityIndex]; 
